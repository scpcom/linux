...
/*
 * FB driver for the ST7789x LCD Controller
 *
...
MODULE_PARM_DESC(panel, "type of attached panel");
...
MODULE_ALIAS("spi:st7789x");
MODULE_ALIAS("platform:st7789x");

MODULE_DESCRIPTION("FB driver for the ST7789x LCD Controller");
