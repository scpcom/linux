...
static __maybe_unused const char *kbase_ipa_model_name_from_id(u32 gpu_id)
{
 ...
 * Return: Power consumption, in mW. Range: 0 < p < 2^13 (0W to ~8W)
 */
static __maybe_unused u32 kbase_scale_static_power(const u32 c, const u32 voltage)
{
	/* Range: 2^8 < v2 < 2^16 m(V^2) */
	const u32 v2 = (voltage * voltage) / 1000;
