...
#if (((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 94)) && defined(KERNEL_AOSP)) || (LINUX_VERSION_CODE > KERNEL_VERSION(6, 2, 0) && LINUX_VERSION_CODE < KERNEL_VERSION(6, 9, 0)))
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 1, 0))
		rwnx_cfg80211_add_key(wiphy, dev, 0, sme->key_idx, false, NULL, &key_params);
#else
