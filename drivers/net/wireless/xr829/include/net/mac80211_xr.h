...
/**
 * xr_ieee80211_tx_info_clear_status - clear TX status
 *
 ...
 */
static inline void
xr_ieee80211_tx_info_clear_status(struct ieee80211_tx_info *info)
{
	int i;
 ...
 *	the driver can fetch them with xr_mac80211_get_buffered_bc().
 *
...
/**
 * xr_mac80211_get_buffered_bc - accessing buffered broadcast and multicast frames
 ...
 * call ieee80211_beacon_get() first. xr_mac80211_get_buffered_bc() returns
 * NULL if the previous generated beacon was not DTIM, so the low-level driver
 * does not need to check for DTIM beacons separately and should be able to
 * use common code for all beacons.
 */
struct sk_buff *
xr_mac80211_get_buffered_bc(struct ieee80211_hw *hw, struct ieee80211_vif *vif);
...
static inline enum nl80211_iftype
xr_ieee80211_vif_type_p2p(struct ieee80211_vif *vif)
{
