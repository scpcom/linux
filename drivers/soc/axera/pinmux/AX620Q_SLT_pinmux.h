0x0230000C, 0x00020043,  /* PadName = VI_D0                Fuction = XXX */
0x02300018, 0x00040003,  /* PadName = VI_D1                Fuction = I2S0_SCLK */
0x02300024, 0x00000003,  /* PadName = VI_D2                Fuction = XXX */
...
0x02304024, 0x00010083,  /* PadName = I2C1_SCL             Fuction = XXX */
0x02304030, 0x00060083,  /* PadName = I2C1_SDA             Fuction = XXX */
...
0x02304084, 0x00010083,  /* PadName = UART3_TXD            Fuction = XXX */
0x02304090, 0x00060003,  /* PadName = UART3_RXD            Fuction = XXX */
0x104F0060, 0x00060008,  /* PadName = EPHY_RSTN            Fuction = XXX */
0x104F006C, 0x00060083,  /* PadName = EPHY_LED0            Fuction = XXX */
0x104F0078, 0x00060003,  /* PadName = EPHY_LED1            Fuction = XXX */
0x104F0084, 0x0000000F,  /* PadName = RGMII_RXD0           Fuction = XXX */
0x104F0090, 0x0000000F,  /* PadName = RGMII_RXD1           Fuction = XXX */
0x104F009C, 0x0000000F,  /* PadName = RGMII_RXDV           Fuction = XXX */
0x104F00A8, 0x0000000F,  /* PadName = RGMII_RXCLK          Fuction = XXX */
0x104F00CC, 0x0000000F,  /* PadName = RGMII_TXD0           Fuction = XXX */
0x104F00D8, 0x0000000F,  /* PadName = RGMII_TXD1           Fuction = XXX */
0x104F00E4, 0x0000000F,  /* PadName = RGMII_TXCLK          Fuction = XXX */
0x104F00F0, 0x0000000F,  /* PadName = RGMII_TXEN           Fuction = XXX */
0x104F100C, 0x00000045,  /* PadName = SD_DAT0              Fuction = XXX */
0x104F1018, 0x00000045,  /* PadName = SD_DAT1              Fuction = XXX */
0x104F1024, 0x00000005,  /* PadName = SD_CLK               Fuction = SD_CLK */
0x104F1030, 0x00000045,  /* PadName = SD_CMD               Fuction = XXX */
0x104F103C, 0x00000045,  /* PadName = SD_DAT2              Fuction = XXX */
0x104F1048, 0x00000045,  /* PadName = SD_DAT3              Fuction = XXX */
...
0x104F2024, 0x00000008,  /* PadName = SDIO_CLK             Fuction = XXX */
0x0230A00C, 0x00060003,  /* PadName = CDTX_L0N             Fuction = XXX */
0x0230A018, 0x00060003,  /* PadName = CDTX_L0P             Fuction = XXX */
0x0230A024, 0x00060003,  /* PadName = CDTX_L1N             Fuction = XXX */
0x0230A030, 0x00060003,  /* PadName = CDTX_L1P             Fuction = XXX */
0x0230A03C, 0x00060003,  /* PadName = CDTX_L2N             Fuction = XXX */
0x0230A048, 0x00060003,  /* PadName = CDTX_L2P             Fuction = XXX */
0x0230A054, 0x00000003,  /* PadName = CDTX_L3N             Fuction = CDTX_L3N */
0x0230A060, 0x00060003,  /* PadName = CDTX_L3P             Fuction = XXX */
0x0230A06C, 0x00060003,  /* PadName = CDTX_L4N             Fuction = XXX */
0x0230A078, 0x00060003,  /* PadName = CDTX_L4P             Fuction = XXX */
0x02301024, 0x00020003,  /* PadName = THM_AIN1             Fuction = PWM11 */
0x02301030, 0x00000003,  /* PadName = THM_AIN0             Fuction = THM_AIN0 */
0x02302018, 0x00000003,  /* PadName = GPIO3_A1             Fuction = XXX */
0x02302024, 0x00000003,  /* PadName = GPIO3_A2             Fuction = XXX */
...
0x0230206C, 0x00060003,  /* PadName = BOND2                Fuction = XXX */
0x02302078, 0x00000043,  /* PadName = SYS_RSTN_OUT         Fuction = SYS_RSTN_OUT */
0x02302090, 0x00060003,  /* PadName = TMS                  Fuction = XXX */
0x0230209C, 0x00060003,  /* PadName = TCK                  Fuction = XXX */
0x023020A8, 0x00060003,  /* PadName = SD_PWR_EN            Fuction = XXX */
