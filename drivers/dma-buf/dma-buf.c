...
EXPORT_SYMBOL_NS_GPL(dma_buf_begin_cpu_access_partial, DMA_BUF);
...
EXPORT_SYMBOL_NS_GPL(dma_buf_end_cpu_access_partial, DMA_BUF);
...
EXPORT_SYMBOL_NS_GPL(dma_buf_get_uuid, DMA_BUF);
