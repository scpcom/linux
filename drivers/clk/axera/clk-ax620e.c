...
#define CPUPLL_MIN_RATE 1000000000
#define CPUPLL_MAX_RATE 1200000000
#define CPUPLL_TARGET_RATE 1000000000
#define CPUPLL_TARGET_RATE_INT 996000000
...
//	{AX620X_PLL_CPLL,  "hpll","cpll_12m", GRP_PLL_RE_OPEN, HPLL_ON_CFG, HPLL_CFG0, HPLL_CFG1, HPLL_STS,GRP_PLL_RDY_STS, 6, HPLL_REF_FREQ, HPLL_MIN_RATE, HPLL_MAX_RATE},
	{AX620X_PLL_CPULL, "cpupll","cpll_12m", GRP_PLL_RE_OPEN, CPUPLL_ON_CFG, CPUPLL_CFG0, CPUPLL_CFG1, CPUPLL_STS,GRP_PLL_RDY_STS, 3, CPUPLL_REF_FREQ, CPUPLL_MIN_RATE, CPUPLL_MAX_RATE,CPUPLL_TARGET_RATE_INT,CPUPLL_TARGET_RATE},
...
static struct axera_gate_clock ax620x_gate_clks_common[] __initdata = {
	...
	{AX620X_CLK_DPHYTX_TLB_EB, "clk_dphytx_tlb_eb", "cpll_24m", CLK_SET_RATE_PARENT, 0x24, 10, 1, 0, 0, 0, 0,},
	...
	{AX620X_MCLK5_EB, "MCLK5_eb", "MCLK5_divn", CLK_SET_RATE_PARENT, 0x24, 5, 1, 0, 0, 0, 0,},
	{AX620X_MCLK4_EB, "MCLK4_eb", "MCLK4_divn", CLK_SET_RATE_PARENT, 0x24, 4, 1, 0, 0, 0, 0,},
	{AX620X_MCLK3_EB, "MCLK3_eb", "MCLK3_divn", CLK_SET_RATE_PARENT, 0x24, 3, 1, 0, 0, 0, 0,},
	{AX620X_MCLK2_EB, "MCLK2_eb", "MCLK2_divn", CLK_SET_RATE_PARENT, 0x24, 2, 1, 0, 0, 0, 0,},
	{AX620X_MCLK1_EB, "MCLK1_eb", "MCLK1_divn", CLK_SET_RATE_PARENT, 0x24, 1, 1, 0, 0, 0, 0,},
...
static struct axera_gate_clock ax620x_gate_clks_dispc[] __initdata = {
	{AX620X_CLK_DPHY_TX_REF_EB, "clk_dphy_tx_ref_eb", "cpll_12m", CLK_SET_RATE_PARENT, 0x4, 1, 1, 0, 0, 0, 0,},
	{AX620X_CLK_DPHY_TX_ESC_EB, "clk_dphy_tx_esc_eb", "clk_dphy_tx_esc_sel", CLK_SET_RATE_PARENT, 0x4, 0, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_LVDS_TX_EB, "pclk_lvds_tx_eb", "clk_dispc_glb_sel", CLK_SET_RATE_PARENT, 0x8, 9, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_DSI_EB, "pclk_dsi_eb", "clk_dispc_glb_sel", CLK_SET_RATE_PARENT, 0x8, 8, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_CSI_EB, "pclk_csi_eb", "clk_dispc_glb_sel", CLK_SET_RATE_PARENT, 0x8, 7, 1, 0, 0, 0, 0,},
	{AX620X_CLK_DSI_TX_ESC_EB, "clk_dsi_tx_esc_eb", "clk_dphy_tx_esc_sel", CLK_SET_RATE_PARENT, 0x8, 6, 1, 0, 0, 0, 0,},
	{AX620X_CLK_DSI_SYS_EB, "clk_dsi_sys_eb", "clk_dispc_glb_sel", CLK_SET_RATE_PARENT, 0x8, 5, 1, 0, 0, 0, 0,},
	...
	{AX620X_CLK_DPHY2DSI_HS_EB, "clk_dphy2dsi_hs_eb", "need_modify", CLK_SET_RATE_PARENT, 0x8, 2, 1, 0, 0, 0, 0,},
...
static struct axera_gate_clock ax620x_gate_clks_periph[] __initdata = {
	...
	{AX620X_CLK_PWM23_EB, "clk_pwm23_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 30, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM22_EB, "clk_pwm22_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 29, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM21_EB, "clk_pwm21_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 28, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM20_EB, "clk_pwm20_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 27, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM13_EB, "clk_pwm13_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 26, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM12_EB, "clk_pwm12_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 25, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM11_EB, "clk_pwm11_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 24, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM10_EB, "clk_pwm10_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 23, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM03_EB, "clk_pwm03_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 22, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM02_EB, "clk_pwm02_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 21, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM01_EB, "clk_pwm01_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 20, 1, 0, 0, 0, 0,},
	{AX620X_CLK_PWM00_EB, "clk_pwm00_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 19, 1, 0, 0, 0, 0,},
	{AX620X_CLK_LPC_PERI_EB, "clk_lpc_peri_eb", "cpll_24m", CLK_SET_RATE_PARENT, 0x8, 18, 1, 0, 0, 0, 0,},
	{AX620X_CLK_DW_DMA_EB, "clk_dw_dma_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 3, 1, 0, 0, 0, 0,},
	{AX620X_ACLK_AX_DMA_PER_EB, "aclk_ax_dma_per_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x8, 0, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_PWM0_EB, "pclk_pwm0_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xC, 31, 1, 0, 0, 0, 0,},
	...
	{AX620X_CLK_TIMER1_EB, "clk_timer1_eb", "clk_timer_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xC, 0, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_TIMER1_EB, "pclk_timer1_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x10, 6, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_TIMER0_EB, "pclk_timer0_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x10, 5, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_PWM2_EB, "pclk_pwm2_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x10, 1, 1, 0, 0, 0, 0,},
	{AX620X_PCLK_PWM1_EB, "pclk_pwm1_eb", "pclk_top_sel", CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x10, 0, 1, 0, 0, 0, 0,},
};
